...
- Packer: c'est un outil permettant de créer des imagess personnalisés pour plusieurs Plateforme cloud et de Virtualisation
...
![Installation de Packer](imagess/install_packer1.png)

Une fois l'installation terminée , nous allons vérifier qu'il est bien présent:

![check packer](imagess/check_packer.png)
...
![Installation Terraform](imagess/install_terraform.png)

Une fois l'installation terminée , nous allons vérifier:

![check terraform](imagess/check_terraform.png)
...
![create project](images/gitlab.png)
...
![packer](imagess/packer-images.png)
...
![variables](imagess/variables.png)
