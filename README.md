...
![create project](image/gitlab.png)
...
Une fois le build terminée, nous avons une image de disponible sur aws:

![packer](images/packer-image.png)
...
![apply](image/apply.tf)

Visualisons sur notre console AWS:

![terraform](image/virtual-server.png)
...
Réaliser la même opération pour la variable IMAGE_NAME qui représente l'URL du registre du conteneur lié au projet spécifique. Cette URL dépend de l'instance GitLab.
